...
Planeta = os.path.join(directorio_imagenes, "Habitat_Marte.png")

def Pantalla_Habitat():
    #Dimensiones de la ventana
    ancho, alto = 1280, 720

    #Creacion de la ventana
    ventana = pygame.display.set_mode((ancho, alto))
    pygame.display.set_caption("Información sobre el habitat en Marte")

    #Cargar de la imagen de fondo
