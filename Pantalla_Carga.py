...
#Definimos la funcion Seleccion Planeta
...
def Pantalla_Carga():
    ...
    while loading:
        ...
        #Rotacion y dibuja la imagen del planeta
        ...
        #Controles de la velocidad de fotogramas
        clock.tick(90)  # Puedes ajustar esto para cambiar la velocidad de la animación

        #Simulacion de la carga completada después de un cierto tiempo
